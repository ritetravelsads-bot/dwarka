...
if ($httpCode < 200 || $httpCode >= 300) {
    ...
    exit;
        ...
        if (empty($project['gallery']) && !empty($project['slug'])) {
            ...
            $custom_canonical = "https://www.dwarkaexpresswayncr.com/" . ($project['slug'] ?? $slug);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <head>
        ...
        <link rel="canonical" href="https://www.dwarkaexpresswayncr.com/<?= htmlspecialchars($project['slug'] ?? $slug) ?>" />
